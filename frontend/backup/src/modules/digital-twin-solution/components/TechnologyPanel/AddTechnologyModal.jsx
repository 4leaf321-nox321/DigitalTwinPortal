...
const AddTechnologyModal = ({ 
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title={editingTech ? '솔루션 정보 수정' : '새로운 솔루션 추가'}
      maxWidth="620px"
      ...
      <form onSubmit={handleSubmit} className="technology-form">
        ...
        <div className="form-group">
          ...
          <div className="adoption-status-group">
            <label className="adoption-option">
              ...
              <span className="adoption-description">현재 사용 중이거나 도입 완료된 솔루션</span>
            </label>
            <label className="adoption-option">
              <input
                type="radio"
              ...
              <span className="adoption-description">평가 중이거나 아직 도입하지 않은 솔루션</span>
            </label>
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="이 솔루션에 대한 상세한 설명을 입력해주세요. (선택사항)"
            rows="4"
          />
        </div>

...
const GanttChart = ({ 
  ...
  useEffect(() => {
    console.log('\n=== 범위 디버깅 (통일) ===');
    console.log('projectRange:', projectRange.start.toLocaleDateString('ko-KR'), '~', projectRange.end.toLocaleDateString('ko-KR'));
    console.log('gridRange:', gridRange.start.toLocaleDateString('ko-KR'), '~', gridRange.end.toLocaleDateString('ko-KR'));
    console.log('=========================');
  ...
  useEffect(() => {
    ...
    console.log('그리드 범위:', gridRange.start.toLocaleDateString('ko-KR'), '~', gridRange.end.toLocaleDateString('ko-KR'));
          ...
          <div className="gantt-body">
            {tasksToDisplay.map((task, index) => {
              ...
              if (index === 0) {
                ...
                console.log(`그리드 시작: ${gridRange.start.toLocaleDateString('ko-KR')}`);

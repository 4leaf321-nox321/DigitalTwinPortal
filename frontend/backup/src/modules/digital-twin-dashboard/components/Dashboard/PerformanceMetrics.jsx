...
const PerformanceMetrics = ({ projects, statusColors }) => {
  ...
  const metrics = useMemo(() => {
    ...
    projects.forEach(project => {
      ...
      // 과제목표별 성과 분류
      const objective = project.과제목표 || '기타';
      if (!performancesByObjective[objective]) {
        performancesByObjective[objective] = 0;
      }
      performancesByObjective[objective] += performances.length;

...
export const useTodayPosition = (displayRange, timeUnits, timeType, subUnitWidth, scale) => {
  return useMemo(() => {
    ...
    console.log('실제 오늘:', now.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
    console.log('계산용 오늘:', today.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
    console.log('범위 시작:', normalizedStart.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
    console.log('범위 끝:', normalizedEnd.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
    ...
    switch (timeType) {
      ...
      case 'weeks':
        ...
        console.log('표시 시작 (주의 월요일):', displayStart.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
...
const calculateMonthlyTodayPositionByWeek = (today, rangeStart, weekWidth) => {
  ...
  console.log('오늘:', today.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
  console.log('범위 시작:', rangeStart.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
  ...
  console.log('표시 시작 (주의 월요일):', displayStart.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
  console.log('오늘이 포함된 주:', todayWeek.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
...
const calculateYearlyTodayPosition = (today, rangeStart, rangeEnd, timeUnits, monthWidth) => {
  ...
  console.log('실제 오늘:', today.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
  console.log('범위 시작:', rangeStart.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));
  ...
  console.log('표시 시작:', displayStart.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' }));

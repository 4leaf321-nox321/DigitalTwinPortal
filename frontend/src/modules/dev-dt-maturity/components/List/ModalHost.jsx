...
const ModalHost = ({ kind, divisionId, divisionName, divisions = [], denyReason, modelKinds, initialId = null,
                     sector = 'simulation', sectorDef = null, accuracyRules = [], processSteps = [], factory = null, onClose, onChanged }) => {
  ...
  return (
    <ItemManagerModal
      kind={kind} sector={sector} sectorDef={sectorDef} accuracyRules={accuracyRules} processSteps={processSteps} factory={factory} divisionId={divisionId} allMode={allMode} divisions={divisions}

...
THREAD_SEED = {
    'MX': [
        ...
        ('manufacturing', 'design_to_process', '설계그룹', 'Teamcenter', 'Teamcenter', '제품기술', 'Teamcenter', {'link_mode': 'sync', 'traceability': ['identity', 'version', 'up_link', 'down_link'], 'consistency': 'single_source', 'scope': 'all', 'stability': 97}, 50),
        ('manufacturing', 'process_to_equipment', '제품기술', 'Teamcenter', '데이터 허브', '제조', 'MES', {'link_mode': 'api', 'traceability': ['identity', 'version'], 'consistency': 'master', 'scope': 'derived_some', 'stability': 85}, 20),
        ('bom_change', 'ebom_to_mbom', '설계그룹', 'Teamcenter', 'Teamcenter', '제품기술', 'SAP ERP', {'link_mode': 'api', 'traceability': ['identity', 'version', 'provenance'], 'consistency': 'master', 'scope': 'all', 'stability': 93}, 60),
    ],
    'VD': [
        ...
        ('manufacturing', 'design_to_process', '설계그룹', 'Teamcenter', 'Teamcenter', '제품기술', 'Teamcenter', {'link_mode': 'api', 'traceability': ['identity', 'version'], 'consistency': 'master', 'scope': 'derived_some', 'stability': 90}, 40),
    ],
    '생활가전': [
        ('manufacturing', 'design_to_process', '설계그룹', 'Teamcenter', 'Teamcenter', '제품기술', 'Teamcenter', {'link_mode': 'sync', 'traceability': ['identity', 'version', 'down_link'], 'consistency': 'single_source', 'scope': 'all', 'stability': 96}, 45),
        ('manufacturing', 'process_to_equipment', '제품기술', 'Teamcenter', 'MES', '제조', 'MES', {'link_mode': 'api', 'traceability': ['identity', 'version'], 'consistency': 'master', 'scope': 'all', 'stability': 91}, 30),
    ...
    'NW': [
        ...
        ('bom_change', 'ebom_to_mbom', '설계그룹', 'Teamcenter', 'Teamcenter', '제품기술', 'SAP ERP', {'link_mode': 'api', 'traceability': ['identity', 'version'], 'consistency': 'master', 'scope': 'derived_some', 'stability': 89}, 40),
    ],
    '의료기기': [
